...
?>	
	...
	<a href="admin_add.php" class="btn btn-primary"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;Add Book</a>
	<a href="admin_addpublisher.php" class="btn btn-primary"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;Add Publisher</a>
